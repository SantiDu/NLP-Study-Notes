...
\subsection{SkipGram}
SkipGram or Skip-NGram, opposite to CBOW which uses surrounding words to predict a central word, uses a central word to predict surrounding words. How many surrounding words is a hyperparameter we can tune, usually between 5 and 20.
